...
<body class="hold-transition sidebar-mini">
	...
	<div class="flash-data" data-flashdataSuccess="<?= $this->session->userdata('announceFlashSuccess'); ?>"
			data-flashdataWarning="<?= $this->session->userdata('announceFlashWarning'); ?>"></div>
	<script>
	...
	<?php
	var_dump($this->session->flashdata('checkDEBUG'));
		unset(
			$_SESSION['announceFlashSuccess'],
			$_SESSION['announceFlashWarning']
		);
	?>
